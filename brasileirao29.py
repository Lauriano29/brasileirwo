...
def nome_do_time(dados,id_numerica):
    nomep = dados["equipes"][id_numerica]['nome-comum']
    return nomep
...
def id_campeao(dados):
    ganhador = dados['fases']['2700']['classificacao']['grupo']['Único'][0]
    return ganhador
...
def nome_campeao(dados):
    ganhador = dados['fases']['2700']['classificacao']['grupo']['Único'][0]
    ncapeao = dados['equipes'][ganhador]['nome-comum']
    return ncapeao
...
def qtos_libertadores(dados):
    finalistas = dados['fases']['2700']['faixas-classificacao']['classifica1']
    finalistas2 = finalistas.split('-')
    x= finalistas2
    return finalistas2
